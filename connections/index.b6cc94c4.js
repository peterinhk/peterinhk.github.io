...
r=e.offsetWidth,o=e.offsetHeight;n({width:r,height:o})});return t.observe(e,{box:"border-box"}),()=>t.unobserve(e)}n(void 0)},[e]),t}(U),B=null!==(n=null==W?void 0:W.width)&&void 0!==n?n:0,H=null!==(r=null==W?void 0:W.height)&&void 0!==r?r:0,G="number"==typeof P?P:{top:0,right:0,bottom:0,left:0,...P},q=Array.isArray(_)?_:[_],Q=q.length>0,K={padding:G,boundary:q.filter(s_),// with `strategy: 'fixed'`, this is the only way to get it to respect boundaries
...
const dI=["mobile","smarttv","wearable"],dM=new dz.UAParser,dF=dM.getBrowser(),dL=dM.getDevice(),d$=(e,t,n,r,o=!0)=>{let i=window.location.href,a=`Black Connections #${ov}
